...
const Payments1 = ({ onSubmit }) => (
  <div>
    ...
    <div className="box1">
       ...
       <h3 className="l2"><span id="pn">60 Classes Package</span><span id="pri">1920</span></h3>
       <hr id="hr" color="#00C2B1" />
       <h3 className="l2"><span id="total">Total</span><span id="totalpri">1920</span></h3>
       <form >
